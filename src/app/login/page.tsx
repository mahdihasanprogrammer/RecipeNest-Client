...
const LoginPage = () => {
  ...
  // Quick setup helper for matching your PRD's item 10: "Demo login button — auto-fills a demo account"
  ...
  return (
    <div className="min-h-screen bg-[#0f0d0b] flex relative overflow-hidden">
      ...
      <div className="hidden lg:flex w-[45%] bg-[#14110f]/40 border-l border-white/10 relative items-center justify-center overflow-hidden">
        <div className="absolute -top-20 -right-20 w-100 h-100 bg-amber-600/10 rounded-full blur-[100px]" />
        <div className="absolute -bottom-20 -left-10 w-100 h-100 bg-orange-600/10 rounded-full blur-[100px]" />
      ...
      <div className="w-full lg:w-[55%] flex flex-col justify-center px-6 sm:px-16 lg:px-20 xl:px-28 py-12 relative z-10 overflow-y-auto">
        <div className="max-w-md w-full mx-auto lg:mx-0 bg-linear-to-b from-white/3 to-white/1 border border-white/10 rounded-3xl p-6 sm:p-8 backdrop-blur-3xl shadow-[0_0_50px_rgba(245,158,11,0.02)]">
          ...
          <div className="grid grid-cols-2 gap-3 mb-5">
            <Button
              ...
              className="bg-white/5 border border-white/10 hover:border-amber-500/30 text-white/80 font-medium text-xs py-2 rounded-xl flex items-center justify-center gap-2 transition-all duration-200 active:scale-95"
            >
            ...
            <Button
              ...
              className="bg-white/5 border border-white/10 hover:border-orange-500/30 text-white/80 font-medium text-xs py-2 rounded-xl flex items-center justify-center gap-2 transition-all duration-200 active:scale-95"
            >
          ...
          <div className="relative mb-5 flex items-center justify-center">
            ...
            <span className="relative bg-[#13100e] px-2 text-[9px] font-bold tracking-widest text-white/30 uppercase">
              Or Use Credentials
            </span>
          </div>
