...
const RegisterPage = () => {
  ...
  const handleSignUp = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (data) {
        router.push('/login'); // Updated to match PRD routing
  ...
  return (
    <div className="min-h-screen bg-[#0f0d0b] flex relative overflow-hidden">
      ...
      <div className="hidden lg:flex w-[45%] bg-[#14110f]/40 border-l border-white/10 relative items-center justify-center p-12 overflow-hidden">
        ...
        {/* Display Presentation Content (PRD Requirements Integrated) */}
        <div className="relative z-10 max-w-sm flex flex-col gap-6">
          ...
          {/* Value Propositions matched to PRD section 6.4 */}
      ...
      <div className="w-full lg:w-[55%] flex flex-col justify-center px-6 sm:px-16 lg:px-20 xl:px-28 py-12 relative z-10 overflow-y-auto">
        ...
        <div className="max-w-md w-full mx-auto lg:mx-0 bg-linear-to-b from-white/3 to-white/1 border border-white/10 rounded-3xl p-6 sm:p-8 backdrop-blur-3xl shadow-[0_0_50px_rgba(245,158,11,0.02)]">
          ...
          {/* Top Decorative Food Icon Layer */}
