                                ...
                                >
                                    ...
                                    <div className="pt-2">
                                        <Link
                                            ...
                                            href={slide.ctaLink}
                                            endContent={<FiArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />}
                                            className="bg-linear-to-r from-orange-600 to-amber-600 text-white font-bold text-sm px-6 py-3 rounded-xl hover:opacity-95 shadow-lg shadow-orange-500/20 border border-white/10 group cursor-pointer transition-all active:scale-95"
                                        >
                                            {slide.ctaText}
                                        </Link>
                                    </div>
                                ...
                                <div className="lg:col-span-6 w-full flex items-center justify-center relative">
                                    ...
                                    >
                                        ...
                                        <div className="absolute bottom-4 left-0 right-0 z-20 flex items-center justify-center gap-3">
                                            <button
                                                type="button" // HTML সেফটি নিশ্চিত করতে টাইপ বাটন দেওয়া হলো
                                                onClick={(e) => {
                                                    e.stopPropagation();
                                                    swiper?.slidePrev();
                                                }}
